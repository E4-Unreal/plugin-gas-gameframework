 ...
 */
UCLASS()
class GGFCORE_API AGGFActor : public AActor, public IAbilitySystemInterface
{
    GENERATED_BODY()
...
public:
    AGGFActor(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
