...
#include "GGFEffectBox.generated.h"
 ...
 */
UCLASS()
class GGFCORE_API AGGFEffectBox : public AGGFTriggerBox
{
    GENERATED_BODY()
...
public:
    AGGFEffectBox(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
